...
use outbox_relayer::{PeerEnvelope, PeerMessagesOutboxRelayer};
...
pub fn setup_peer_communication(
    ...
    let outbox_orchestrator = PeerMessagesOutboxRelayer::new(repository, rx, 10, server_peer_id);
